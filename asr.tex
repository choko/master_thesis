...
There are several ways how to implement VAD,
  for example, support vector machines \cite{mesgarani2006discrimination}, gaussian mixture models \cite{ng2012developing} or deep neural networks \cite{ryant2013speech} can be used.
